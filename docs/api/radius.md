vl.<b>radius</b>(<em>...values</em>)

Specify the <code>radius</code> encoding channel.

## <code>radius</code> Method Overview
...
## <code>radius</code> API Reference

<a id="aggregate" href="#aggregate">#</a>
<em>radius</em>.<b>aggregate</b>(<em>value</em>)
...
<a id="bin" href="#bin">#</a>
<em>radius</em>.<b>bin</b>(<em>value</em>)
...
<em>radius</em>.<b>stack</b>(<em>value</em>)
...
<em>radius</em>.<b>type</b>(<em>value</em>)
