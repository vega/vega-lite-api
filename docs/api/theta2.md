vl.<b>theta2</b>(<em>...values</em>)

Specify the <code>theta2</code> encoding channel.

## <code>theta2</code> Method Overview
...
## <code>theta2</code> API Reference

<a id="aggregate" href="#aggregate">#</a>
<em>theta2</em>.<b>aggregate</b>(<em>value</em>)
...
<a id="bin" href="#bin">#</a>
<em>theta2</em>.<b>bin</b>(<em>value</em>)
...
<em>theta2</em>.<b>type</b>(<em>value</em>)
