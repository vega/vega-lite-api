vl.<b>url</b>(<em>...values</em>)

Specify the <code>url</code> encoding channel.
...
<em>url</em>.<b>aggregate</b>(<em>value</em>)
...
<em>url</em>.<b>formatType</b>(<em>value</em>)
...
<em>url</em>.<b>hours</b>(<em>field</em>)

Apply the <code>hours</code> timeUnit operation prior to encoding.

<a id="if" href="#if">#</a>
<em>url</em>.<b>if</b>(<em>...condition</em>)
...
<em>url</em>.<b>labelExpr</b>(<em>value</em>)
...
<em>url</em>.<b>type</b>(<em>value</em>)
