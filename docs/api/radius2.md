vl.<b>radius2</b>(<em>...values</em>)

Specify the <code>radius2</code> encoding channel.

## <code>radius2</code> Method Overview
...
## <code>radius2</code> API Reference

<a id="aggregate" href="#aggregate">#</a>
<em>radius2</em>.<b>aggregate</b>(<em>value</em>)
...
<a id="bin" href="#bin">#</a>
<em>radius2</em>.<b>bin</b>(<em>value</em>)
...
<em>radius2</em>.<b>type</b>(<em>value</em>)
