...
vl.<b>x</b>(<em>...values</em>)

Specify the <code>x</code> encoding channel.

## <code>x</code> Method Overview

* <em>x</em>.<a href="#aggregate">aggregate</a>
* <em>x</em>.<a href="#argmax">argmax</a>
* <em>x</em>.<a href="#argmin">argmin</a>
* <em>x</em>.<a href="#average">average</a>
* <em>x</em>.<a href="#axis">axis</a>
* <em>x</em>.<a href="#bin">bin</a>
* <em>x</em>.<a href="#ci0">ci0</a>
* <em>x</em>.<a href="#ci1">ci1</a>
* <em>x</em>.<a href="#count">count</a>
* <em>x</em>.<a href="#date">date</a>
* <em>x</em>.<a href="#day">day</a>
* <em>x</em>.<a href="#distinct">distinct</a>
* <em>x</em>.<a href="#field">field</a>
* <em>x</em>.<a href="#fieldN">fieldN</a>
* <em>x</em>.<a href="#fieldO">fieldO</a>
* <em>x</em>.<a href="#fieldQ">fieldQ</a>
* <em>x</em>.<a href="#fieldT">fieldT</a>
* <em>x</em>.<a href="#hours">hours</a>
* <em>x</em>.<a href="#if">if</a>
* <em>x</em>.<a href="#impute">impute</a>
* <em>x</em>.<a href="#max">max</a>
* <em>x</em>.<a href="#mean">mean</a>
* <em>x</em>.<a href="#median">median</a>
* <em>x</em>.<a href="#milliseconds">milliseconds</a>
* <em>x</em>.<a href="#min">min</a>
* <em>x</em>.<a href="#minutes">minutes</a>
* <em>x</em>.<a href="#missing">missing</a>
* <em>x</em>.<a href="#month">month</a>
* <em>x</em>.<a href="#q1">q1</a>
* <em>x</em>.<a href="#q3">q3</a>
* <em>x</em>.<a href="#quarter">quarter</a>
* <em>x</em>.<a href="#scale">scale</a>
* <em>x</em>.<a href="#seconds">seconds</a>
* <em>x</em>.<a href="#sort">sort</a>
* <em>x</em>.<a href="#stack">stack</a>
* <em>x</em>.<a href="#stderr">stderr</a>
* <em>x</em>.<a href="#stdev">stdev</a>
* <em>x</em>.<a href="#stdevp">stdevp</a>
* <em>x</em>.<a href="#sum">sum</a>
* <em>x</em>.<a href="#timeHM">timeHM</a>
* <em>x</em>.<a href="#timeHMS">timeHMS</a>
* <em>x</em>.<a href="#timeMD">timeMD</a>
* <em>x</em>.<a href="#timeMDH">timeMDH</a>
* <em>x</em>.<a href="#timeMS">timeMS</a>
* <em>x</em>.<a href="#timeQM">timeQM</a>
* <em>x</em>.<a href="#timeSMS">timeSMS</a>
* <em>x</em>.<a href="#timeUnit">timeUnit</a>
* <em>x</em>.<a href="#timeYM">timeYM</a>
* <em>x</em>.<a href="#timeYMD">timeYMD</a>
* <em>x</em>.<a href="#timeYMDH">timeYMDH</a>
* <em>x</em>.<a href="#timeYMDHM">timeYMDHM</a>
* <em>x</em>.<a href="#timeYMDHMS">timeYMDHMS</a>
* <em>x</em>.<a href="#timeYQ">timeYQ</a>
* <em>x</em>.<a href="#timeYQM">timeYQM</a>
* <em>x</em>.<a href="#title">title</a>
* <em>x</em>.<a href="#type">type</a>
* <em>x</em>.<a href="#utcHM">utcHM</a>
* <em>x</em>.<a href="#utcHMS">utcHMS</a>
* <em>x</em>.<a href="#utcMD">utcMD</a>
* <em>x</em>.<a href="#utcMDH">utcMDH</a>
* <em>x</em>.<a href="#utcMS">utcMS</a>
* <em>x</em>.<a href="#utcQM">utcQM</a>
* <em>x</em>.<a href="#utcSMS">utcSMS</a>
* <em>x</em>.<a href="#utcYM">utcYM</a>
* <em>x</em>.<a href="#utcYMD">utcYMD</a>
* <em>x</em>.<a href="#utcYMDH">utcYMDH</a>
* <em>x</em>.<a href="#utcYMDHM">utcYMDHM</a>
* <em>x</em>.<a href="#utcYMDHMS">utcYMDHMS</a>
* <em>x</em>.<a href="#utcYQ">utcYQ</a>
* <em>x</em>.<a href="#utcYQM">utcYQM</a>
* <em>x</em>.<a href="#utcdate">utcdate</a>
* <em>x</em>.<a href="#utcday">utcday</a>
* <em>x</em>.<a href="#utchours">utchours</a>
* <em>x</em>.<a href="#utcmilliseconds">utcmilliseconds</a>
* <em>x</em>.<a href="#utcminutes">utcminutes</a>
* <em>x</em>.<a href="#utcmonth">utcmonth</a>
* <em>x</em>.<a href="#utcquarter">utcquarter</a>
* <em>x</em>.<a href="#utcseconds">utcseconds</a>
* <em>x</em>.<a href="#utcyear">utcyear</a>
* <em>x</em>.<a href="#utcyearmonth">utcyearmonth</a>
* <em>x</em>.<a href="#valid">valid</a>
* <em>x</em>.<a href="#value">value</a>
* <em>x</em>.<a href="#variance">variance</a>
* <em>x</em>.<a href="#variancep">variancep</a>
* <em>x</em>.<a href="#year">year</a>
* <em>x</em>.<a href="#yearmonth">yearmonth</a>

## <code>x</code> API Reference

<a name="aggregate">#</a>
<em>x</em>.<b>aggregate</b>(<em>value</em>)
...
<a name="impute">#</a>
<em>x</em>.<b>impute</b>(<em>value</em>)
